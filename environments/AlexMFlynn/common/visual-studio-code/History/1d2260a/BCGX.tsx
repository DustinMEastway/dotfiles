  ...
  render: (args: JSX.IntrinsicAttributes & (Overlay | Push)) => 
    <>
      ...
      <Drawer side='right' isOpen={true}>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt, magni culpa dolorem, quia modi architecto porro nisi rem deleniti quod est at rerum in fuga perferendis reiciendis voluptate iste suscipit?
        Ipsa est ipsam nisi minus reprehenderit ab repellendus inventore. Eligendi est perferendis dignissimos earum exercitationem rem ipsa consequatur, accusamus quibusdam ducimus obcaecati consequuntur nemo. Adipisci nisi ducimus laboriosam id animi?
      </Drawer>
    </>
